...
def setup_characters(clip:Clip):
    ...
    clip.add_character_style("四国めたん", style_name="ノーマル",image_path="./resource/character/四国めたん_ノーマル.png")
    clip.add_character_style("四国めたん", style_name="目そらし",image_path="./resource/character/四国めたん_目そらし.png")
    clip.add_character_style("四国めたん", style_name="イエー",image_path="./resource/character/四国めたん_イエー.png")
    clip.add_character_style("四国めたん", style_name="困り顔",image_path="./resource/character/四国めたん_困り顔.png")
    clip.add_character_style("四国めたん", style_name="汗キャー",image_path="./resource/character/四国めたん_汗キャー.png")
    clip.add_character_style("四国めたん", style_name="ペロ",image_path="./resource/character/四国めたん_ペロ.png")
    clip.add_character_style("四国めたん", style_name="あっ",image_path="./resource/character/四国めたん_あっ.png")

    clip.add_character_style("ずんだもん", style_name="ノーマル",image_path="./resource/character/ずんだもん_ノーマル.png")
    clip.add_character_style("ずんだもん", style_name="ビックリ",image_path="./resource/character/ずんだもん_ビックリ.png")
    clip.add_character_style("ずんだもん", style_name="イエー",image_path="./resource/character/ずんだもん_イエー.png")
    clip.add_character_style("ずんだもん", style_name="右手挙げ",image_path="./resource/character/ずんだもん_右手挙げ.png")
    clip.add_character_style("ずんだもん", style_name="困り顔",image_path="./resource/character/ずんだもん_困り顔.png")
    clip.add_character_style("ずんだもん", style_name="目とじ考え",image_path="./resource/character/ずんだもん_目とじ考え.png")
    clip.add_character_style("ずんだもん", style_name="両手挙げ",image_path="./resource/character/ずんだもん_両手挙げ.png")
    clip.add_character_style("ずんだもん", style_name="推理",image_path="./resource/character/ずんだもん_推理.png")
    clip.add_character_style("ずんだもん", style_name="ふんす",image_path="./resource/character/ずんだもん_ふんす.png")
    clip.add_character_style("ずんだもん", style_name="汗アハハ",image_path="./resource/character/ずんだもん_汗アハハ.png")
    clip.add_character_style("ずんだもん", style_name="涙むふ",image_path="./resource/character/ずんだもん_涙むふ.png")
