...
def create_fuchidori_telop_image(text,font_path,font_size,fill_color="white",stroke_fill_color="black",background_color="white",stroke_width=5,back_ground_stroke_width=8):
    ...
    id.multiline_text((7, 0), text,font=font, fill=background_color, stroke_width=back_ground_stroke_width)
    id.multiline_text((7, 0), text, font=font, fill=fill_color, stroke_width=stroke_width, stroke_fill=stroke_fill_color)
